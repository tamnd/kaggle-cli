...
Most of these come down to network reality or how kaggle serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kaggle rate-limits like any public site. kaggle already paces
...
Where a surface is gated, kaggle reads a cookie or token you supply
...
`kaggle`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kaggle actually did
